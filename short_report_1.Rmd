...
danceability_lm_full2 <- lm(danceability ~ energy + loudness*crossover_categ, data = spotify_data_crossover_filtered)

anova(danceability_lm_red, danceability_lm_full)
```
