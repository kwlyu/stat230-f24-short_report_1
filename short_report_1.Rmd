...
ggplot(data = spotify_data_crossover_filtered, aes(x = energy, y = danceability)) + 
  ...
  labs(x = "Energy", y = "Danceability", title = "Energy vs Danceability") -> p1
...
ggplot(data = spotify_data_crossover_filtered, aes(x = loudness, y = danceability)) + 
  ...
  facet_grid(cols = vars(crossover_categ)) -> p2

ggsave("eda_energy.png", p1)
ggsave("eda_loudness.png", p2)
```
...
combined_plot + 
  ...
  plot_annotation(title = "Residual Plot and Normal Q-Q Plot of Spotify MLR") -> p3

ggsave("res+qq.png", p3)
